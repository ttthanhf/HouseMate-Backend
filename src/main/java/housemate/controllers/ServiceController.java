...
public class ServiceController {
	...
	@GetMapping("/rating")
	public ResponseEntity<?> getFeedback(@RequestParam("rating") int requiredRating) {
		List<Service> serviceList = serviceDao.filterByRating(requiredRating);
		if (serviceList.isEmpty())
			// throw new ApiServicesRequestException("Sorry The List Is Empty Now");
			return ResponseEntity.status(HttpStatus.NO_CONTENT)
					.body("Sorry The Services With Rating From " + requiredRating +" Empty!");
