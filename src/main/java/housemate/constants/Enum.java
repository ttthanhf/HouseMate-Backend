...
public class Enum {
	...
	public enum ServiceConfiguration {
	    SERVICE_GROUPS(true),
	    SERVICE_UNITS(true),
	    OFFICE_HOURS_START(false),
	    OFFICE_HOURS_END(false),
	    FIND_STAFF_HOURS(false),
	    MINIMUM_RETURN_HOURS(false),
		...
		String configValue = configService.getConfigValuesOfConfigTypeName(this.valueOf(this.name())).stream()
